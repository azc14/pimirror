...
Any number of actuators can be controlled. A sweeping option is available whereby a range of duty cycles is sent to
a particular actuator whilst other actuators remain constant.
